...
namespace DiscordChat.Settings
{
    public class Globals
    {
        ...
        public class Files
        {
            public static string WorkingDirectory
            {
                get
                {
                    var dir = Path.Combine(FileWriter.GetWorkingDirectory(), "");
            ...
            public static string LanguagesDir
            {
                get
                {
                    var dir = Path.Combine(WorkingDirectory, "lang");
                    if (!FileWriter.DirectoryExists(dir)) FileWriter.CreateDirectory(dir);
                    return dir;
                }
            }
            ...
            {
                return Path.Combine(LanguagesDir, $"messages_{code}.json");
            }
        }
        #endregion
        ...
        public static Dictionary<IPlayer, string> Messages { get; set; } = new();
        public static DiscordClient Discord { get; internal set; }
        public static DiscordChannel DiscordChannel { get; internal set; }
